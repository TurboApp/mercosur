...
@section('breadcrump')
   @component('components.breadcrump',[
        'navigation'    =>  [ 'Inicio' => 'inicio', 'coordinadores' => 'coordinadores', $coordinador->nombre => '' ],
    ])
    @endcomponent()
@endsection
        ...
        <div class="col-sm-8">
            <div class="media">
                <div class="media-left" >
                    <img src="{{asset('img/coordinador.png')}}" 
                ...
                <div class="media-body">
                    <h3 class="media-heading title text-truncate" style="margin-top:.8em;">{{ $coordinador->nombre }}
                    </h3>
    ...
    <div class="row">
            ...
            <div id="oneDate" class="col-md-4 col-md-offset-2">
                <div class="input-group">
                    ...
                    <input type="text" id="fecha" name="fecha" value="{{$coordinador->fecha->format('j/m/Y')}}" class="form-control"  maxlength="10">
                </div>
            </div>    
    ...
    <script>
        $(function () {
            ...
            fecha.on('dp.change', function(e){ 
                ...
                table.ajax.url( "/coordinadores/API/{{$coordinador->id}}/"+date ).load();
            ...
            let table = $('#produccionTable').DataTable( {
                ...
                ajax: "/coordinadores/API/{{$coordinador->id}}",
                columns:[
                    { 
                        //TIPO
                        "data" : "servicio.tipo",
