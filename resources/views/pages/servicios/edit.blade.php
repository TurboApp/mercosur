...
<div class="container-fluid">
    ...
    <div class="row">   
        ...
        @component('components.servicios.edit.datosgenerales',[
            'data'  =>  $servicio
        ])
        @endcomponent()
        ...
        @foreach($servicio->transportes as $transporte)
            @component('components.servicios.edit.transportes',[
                'data' => $transporte
            ])
            @endcomponent() 
        @endforeach()
        ...
        @component('components.servicios.edit.documentos',
            ['data' => $servicio->documentos ])
        @endcomponent 

        <h3 class="title">Archivos</h3>

        @component('components.servicios.edit.archivos',
