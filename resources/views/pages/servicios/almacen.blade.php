...
@section('breadcrump')
    @component('components.breadcrump',[
        'navigation'    =>  [ 'Inicio' => 'inicio', 'Servicios' => 'servicios',  'Nuevo servicio' => 'servicioNuevo', 'Almacén' => '' ],
    ])
    @endcomponent()
@endsection
    ...
    $().ready(function(){
        ...
        $(document).on("click",".open-modal",function(){
            ...
            .then(function(response){
                ...
                $.each(data.documentos, function(key,val){
                    
                    if(val.status == "1"){
                        $('#modal_documentos').append("<li>"+val.tipo_documento+"-"+val.num_documento+"</li>");
                    }else{
                        $('#modal_documentos').append("<li>"+val.tipo_documento+"-"+val.num_documento+" <span class=\"badge light-green accent-4\"><i class=\"fa fa-check\"></i> Cargado</span></li>");
                    }
                });
                $('#goToCarga').attr("href","/servicios/nuevo/Carga/"+datos);
            });
         });
